...
food.forEach(item => {
    a += `
        <div class="card p-3 align-items-center shadow border-0 mx-3 my-3 ms-5" style="width: 25rem; height: 28rem">
          <img src="${item.image}" class="card-img-top" height='200px' alt="...">
            <div class="card-body">
              <h5 class='fw-bold'>${item.name}</h5>
              <h6 class='fw-bold'>Calories : ${item.calories}</h6>
              <h6>Proteins : ${item.proteins}</h6>
              <h6>Fats : ${item.fats}</h6>
              <h6>Carbos : ${item.carbos}</h6>
...
document.querySelector('#col').innerHTML = a
